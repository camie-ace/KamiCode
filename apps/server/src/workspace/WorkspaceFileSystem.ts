...
export class WorkspaceUploadOperationError extends Schema.TaggedError<WorkspaceUploadOperationError>()(
...
export class WorkspaceUploadTargetError extends Schema.TaggedError<WorkspaceUploadTargetError>()(
