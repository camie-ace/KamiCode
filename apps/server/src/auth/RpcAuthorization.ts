...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.threadLock]: AuthOrchestrationOperateScope,
  [WS_METHODS.threadUnlock]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.hostedPreviewFrame]: AuthOrchestrationReadScope,
  [WS_METHODS.hostedPreviewControl]: AuthOrchestrationOperateScope,
