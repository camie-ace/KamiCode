...
projectionRepositoriesLayer("Projection repositories", (it) => {
  ...
  it.effect("recovers abandoned queue rows and terminalizes archived work", () =>
    Effect.gen(function* () {
      ...
      yield* upsertQueue(
        "queue:recover-overdue-scheduled",
        activeThreadId,
        "queued",
        null,
        "2026-03-01T00:00:00.000Z",
      ...
      assert.deepStrictEqual(rows, [
        ...
        { queueId: "queue:recover-overdue-scheduled", status: "queued", turnId: null },
        {
          queueId: "queue:recover-running",
          status: "started",
          turnId: "turn-recovered-running",
        },
        { queueId: "queue:recover-scheduled", status: "queued", turnId: null },
