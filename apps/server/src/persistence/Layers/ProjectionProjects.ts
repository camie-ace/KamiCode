...
import { ModelSelection, ProjectScript, ProjectTestEnvironment } from "@t3tools/contracts";
    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${JSON.stringify(row.testEnvironments)},
          ${row.createdAt},
          ${row.updatedAt},
          ${row.deletedAt}
        )
        ...
        DO UPDATE SET
          ...
          test_environments_json = excluded.test_environments_json,
