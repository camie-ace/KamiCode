...
function makeRunResult(input: BrowserHarnessRunInput): BrowserHarnessRunResult {
  return {
    ...
    artifactPaths: {
      ...
      screenshots: ["C:\\state\\test-harness\\projects\\cwd-project\\runs\\run-1\\screenshots\\01.png"],
    ...
    observations: [
      {
        ...
        url: input.url,
        title: "App",
        screenshotId: "C:\\state\\test-harness\\projects\\cwd-project\\runs\\run-1\\screenshots\\01.png",
