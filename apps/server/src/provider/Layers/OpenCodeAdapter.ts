...
export function makeOpenCodeAdapter(
  ...
  return Effect.gen(function* () {
    ...
    const sendTurn: OpenCodeAdapterShape["sendTurn"] = Effect.fn("sendTurn")(function* (input) {
      ...
      const commandMatch = rawText.match(/^\/([^\s/]+)(?:\s+([\s\S]*))?$/);
      ...
      const injectProjectMemory = !context.projectMemoryInjected && nativeCommand === undefined;
      ...
      return yield* context.promptSemaphore.withPermit(
        Effect.gen(function* () {
                ...
                context.client.session.promptAsync(
                  {
                    ...
                    system: appendRepositoryOperatingContract(
          ...
          if (injectProjectMemory && nativeCommand === undefined) {
