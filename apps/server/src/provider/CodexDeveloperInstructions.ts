...
const staticModeInstructions = (instructions: string, browserToolsAvailable: boolean): string =>
  browserToolsAvailable
    ? instructions
    : instructions.replace(T3_CODE_BROWSER_TOOL_INSTRUCTIONS, "");
