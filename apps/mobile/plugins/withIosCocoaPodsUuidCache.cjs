...
const MARKER = "# kamicode: repair cached CocoaPods UUID allocation before SPM integration";
const UUID_REPAIR = `${MARKER}
    ...
    Pod::UI.puts "KamiCode: reset CocoaPods UUID allocator at #{next_index} (#{existing_uuids.length} existing objects)"
`;
