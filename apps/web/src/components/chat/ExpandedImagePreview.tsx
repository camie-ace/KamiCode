...
import { type ChatGifAttachment, type ChatImageAttachment, isVideoAttachment } from "../../types";
import type {
...
export function buildAttachmentVideoAsset(
  ...
  attachment:
    | ChatFileAttachment
    | { readonly id: string; readonly name: string; readonly mimeType: string },
...
export function buildExpandedImagePreview(
  images: ReadonlyArray<ChatImageAttachment | ChatGifAttachment | ComposerFileAttachment>,
  ...
  const previewableImages = images.flatMap((image) =>
    (image.type === "image" || image.type === "gif") && image.previewUrl
      ? [
          {
            id: image.id,
            src: image.previewUrl,
            name: image.name,
            ...(image.type === "image" ? { source: image.source } : {}),
          },
        ]
      : [],
  );
