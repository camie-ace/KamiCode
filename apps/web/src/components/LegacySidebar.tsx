...
const SidebarProjectItem = memo(function SidebarProjectItem(props: SidebarProjectItemProps) {
  ...
  const updatePrimarySettings = useAtomCommand(serverEnvironment.updateSettings, {
    reportFailure: false,
  });
  const primaryEnvironmentId = usePrimaryEnvironmentId();
  ...
  const submitProjectSharing = useCallback(async () => {
    ...
    if (projectSharingMode === "profile") {
      if (projectSharingProfileId === "__new__") {
        ...
        const updateResult = await updatePrimarySettings({
        ...
        if (updateResult._tag === "Failure") {
          throw squashAtomCommandFailure(updateResult);
        }
