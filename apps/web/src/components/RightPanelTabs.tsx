...
const SURFACE_DISABLED_REASONS = {
  browser: "Browser previews are only available in the KamiCode desktop app.",
  ...
  tests: "Tests are only available when a project is open.",
...
const SURFACE_UNAVAILABLE_HINTS = {
  ...
  tests: "Available when a project is open.",
...
function RightPanelEmptyState(props: {
  ...
  const actions = [
    ...
    },
    {
      ...
      disabledReason: SURFACE_UNAVAILABLE_HINTS.tests,
...
function SurfaceIcon({
  ...
  switch (surface.kind) {
    ...
    case "media":
      return <ImagesIcon className="size-3 shrink-0" />;
    case "tests":
      return <HistoryIcon className="size-3 shrink-0" />;
    case "pull-request":
      return (
...
export function RightPanelTabs(props: RightPanelTabsProps) {
  ...
  const addSurfaceActions = [
    ...
    },
    {
      ...
      shortcut: "E",
      available: props.testsAvailable,
      disabledReason: SURFACE_DISABLED_REASONS.tests,
      onClick: props.onAddTests,
    },
    {
      label: "Device",
