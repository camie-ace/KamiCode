...
1. Install the GitHub CLI on the machine running KamiCode:
   ```bash
   brew install gh
   ```
2. Sign in:
...
2. Add these environment variables to the environment running KamiCode:
   ```bash
   export T3CODE_BITBUCKET_EMAIL="you@example.com"
   export T3CODE_BITBUCKET_API_TOKEN="your-token"
   ```
3. Restart KamiCode and verify the connection in **Source Control settings**
