...
export class PackagedDesktopNativeDependencyMissingError extends Schema.TaggedError<PackagedDesktopNativeDependencyMissingError>()(
...
const AzureTrustedSigningOptionsConfig = Config.all({
  publisherName: Config.string("AZURE_TRUSTED_SIGNING_PUBLISHER_NAME").pipe(
    Config.withDefault(DESKTOP_PUBLISHER_NAME),
  ),
...
export const stageWindowsServerSidecar = Effect.fn("stageWindowsServerSidecar")(function* (input: {
  ...
  const sidecarDependencies = {
    ...
    ...resolveFfiNativeDependencies("win", input.arch, input.ffiRsVersion),
    ...resolveFfiNativeDependencies("linux", input.arch, input.ffiRsVersion),
