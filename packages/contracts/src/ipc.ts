...
export type DesktopUpdateChannel = "latest" | "dev" | "nightly";
...
export const DesktopUpdateChannelSchema = Schema.Literals(["latest", "dev", "nightly"]);
...
export const RevealLocalMediaFileInputSchema = Schema.Struct({
  path: Schema.String.check(Schema.isTrimmed()).check(Schema.isNonEmpty()),
});
export type RevealLocalMediaFileInput = typeof RevealLocalMediaFileInputSchema.Type;
