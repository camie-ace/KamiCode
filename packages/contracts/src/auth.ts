...
export const AuthProjectTriggerRunScope = "project-trigger:run" as const;
...
export const AuthBrowserSessionResultJson = Schema.Struct({
  authenticated: Schema.Literal(true),
  scopes: AuthEnvironmentScopes,
  sessionMethod: ServerAuthSessionMethod,
  expiresAt: Schema.DateTimeUtcFromString,
});
export type AuthBrowserSessionResultJson = typeof AuthBrowserSessionResultJson.Encoded;
...
export const AuthWebSocketTicketResultJson = Schema.Struct({
  ticket: TrimmedNonEmptyString,
  expiresAt: Schema.DateTimeUtcFromString,
});
export type AuthWebSocketTicketResultJson = typeof AuthWebSocketTicketResultJson.Encoded;
