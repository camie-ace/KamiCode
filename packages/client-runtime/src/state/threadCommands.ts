...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    recordWorkflow: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:record-workflow",
      execute: (input: RecordThreadWorkflowInput) => recordThreadWorkflow(input),
      scheduler,
      concurrency,
    }),
