...
KamiCode is a minimal web GUI for coding agents (currently Codex, Claude, Cursor, and OpenCode, more coming soon).

## Installation

> [!WARNING]
> KamiCode currently supports Codex, Claude, Cursor, and OpenCode.
...
KamiCode uses Vite+ (inherited from upstream T3 Code) so you'll need to install the global `vp` command-line tool.
