...
KamiCode is an agent-harness control surface for Codex, Claude, Cursor, Grok Build, and OpenCode.

## Installation

> [!WARNING]
> KamiCode currently supports Codex, Claude, Cursor, Grok Build, and OpenCode.
